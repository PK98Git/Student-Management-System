         ...
         if($_GET['course_id'])
            {
                ...
                $sql2="DELETE FROM course WHERE courseID='$c_id'  ";
...
<body>
    ...
    ?>
        ...
        <div class="mycontainer">
                <h1 class="mt-5">View All Course Data</h1>
                <br><br>
            <div class="limiter">
                            ...
                            <div class="table100-head">
                                <table>
                                    <thead>
                                        ...
                                        <th class="cell100 column2">Course Duration</th>
                                        <th class="cell100 column2">Course Description</th>
                                        <th class="cell100 column2">Course Status</th>
                                        <th class="cell100 column2">Course Image</th>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr class="row100 body">
                                            <td class="cell100 column1"><?php    echo "{$info['courseName']}";  ?></td>
                                            <td class="cell100 column2"><?php    echo "{$info['courseDuration']}";  ?></td>
                                            <td class="cell100 column2"><?php    echo "{$info['courseDescription']}";  ?></td>
                                            <td class="cell100 column2"><?php    echo "{$info['courseStatus']}";  ?></td>
                                            <td class="cell100 column2"><img height="100px" width="100px" src="<?php    echo "{$info['courseImage']}";  ?>"></td>
                                            <td class="cell100 column2"><?php    echo "<a onClick=\"javascript:return confirm('Are You Sure to Delete this'); \" class='btn btn-danger' href='admin_view_course.php?course_id={$info['courseID']}'> Delete </a>";  ?></td>
                                            <td class="cell100 column2"><?php    echo "<a class='btn btn-primary' href='admin_update_course.php?course_id={$info['courseID']}'> Update </a>";  ?></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
