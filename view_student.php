<?php
    ...
    session_start();
        ...
        elseif($_SESSION['usertype']=='student')
        {
         ...
         $sql="SELECT u.id ,u.username , u.email , u.phone ,c.courseName , u.password ,en.payment
            FROM course c , enrolled_course en , user u
            WHERE en.username = u.username AND en.courseID = c.courseID;";
...
<body>
    ...
    ?>
            ...
            <div class="mycontainer">
                 <h1 class="mt-5">View All Student Data</h1>
                <br><br>
            <div class="limiter">
                            ...
                            <div class="table100-head">
                                <table>
                                    ...
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column2">Course</th>
                                        <th class="cell100 column2">Payment Status</th>
                        ...
                        <div class="table100-body js-pscroll ps ps--active-y">
                            ...
                            ?>
                                    <tr class="row100 body">
                                        <td class="cell100 column1"><?php    echo "{$info['username']}";  ?></td>
                                        <td class="cell100 column3"><?php    echo "{$info['email']}";?></td>
                                        <td class="cell100 column2"><?php    echo "{$info['phone']}"  ?></td>
                                        <td class="cell100 column2"><?php    echo "{$info['courseName']}"  ?></td>
                                        <td class="cell100 column2"><?php    echo "{$info['payment']}"  ?></td>
                                        <td class="cell100 column2"> <?php    echo "{$info['password']}"  ?></td>
                                        <td class="cell100 column2"><?php    echo "<a onClick=\"javascript:return confirm('Are You Sure to Delete this'); \" class='btn btn-danger' href='delete.php?username={$info['username']}'> Delete </a>";  ?></td>
                                        <td class="cell100 column2"><?php    echo "<a class='btn btn-primary' href='update_student.php?student_id={$info['id']}'> Update </a>";  ?></td>
                                    </tr>
                                    <?php
                                            }
                                        ?>
